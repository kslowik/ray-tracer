...
fn test_to_json() {
    let sphere = Sphere::new(
        ...
        1.0,
        Material::Lambertian(Lambertian::new(Srgb::new(0.5f32, 0.5f32, 0.5f32))),
    );
    ...
    let tex = Texture::new(Srgb::new(0.5f32, 0.5f32, 0.5f32), "data/earth.jpg", 0.0);
